...
**Status:** Attempted and reverted 2026-07-28, not yet re-attempted. Fixes 3 and 4b from the same brief (`.claude/agents/clio/feature-briefs/B2B-43-demo-stuck-dispatch-and-screenshare-crash.md`) shipped; this one did not.
