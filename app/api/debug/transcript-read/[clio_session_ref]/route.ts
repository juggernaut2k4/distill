...
// completed real test call (this is the third such review tonight, verifying the B2B-67
// meta-narration fix). The raw transcript only exists transiently in Redis (30-min TTL, see
