...
/**
 * B2B-07 — /dashboard/configurator/developer/playground (Requirement Doc
 * Section 4.C, architecture.md §17.3). Calls the four already-live
...
export default function PlaygroundClient({
  ...
  return (
    <ConfiguratorShell
      ...
      backHref={`/dashboard/configurator/developer?partner_account_id=${activePartnerAccountId}`}
    >
      ...
      <Card style={{ marginBottom: 16 }}>
        ...
        {endpoint.playgroundDisabled ? (
          <div>
            ...
            >
              See the full request/response reference on the Developer Docs page →
            </Link>
