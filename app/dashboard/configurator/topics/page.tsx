...
import TopicsConfigClient from './TopicsConfigClient'

export default async function TopicsConfigPage({ searchParams }: { searchParams: { partner_account_id?: string } }) {
  const { userId } = auth()
  ...
  return <TopicsConfigClient accounts={accounts} activePartnerAccountId={activeId} />
}
