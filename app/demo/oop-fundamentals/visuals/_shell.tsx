...
/**
 * Shared page chrome for the 7 "OOP Fundamentals" visuals — nav, back link, and title, so each
  ...
  return (
    <div style={pageStyle}>
      <nav style={navStyle}>
        ...
        <Link href="/demo/oop-fundamentals" style={{ color: COLORS.textMuted, fontSize: 13, textDecoration: 'none' }}>
          ← Back to course
        </Link>
      </nav>
