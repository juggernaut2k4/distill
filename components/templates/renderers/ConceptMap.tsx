...
function CentralNode({ data }: NodeProps) {
  ...
  return (
    <div className="w-[180px] h-[180px] rounded-full bg-[var(--partner-primary,#7C3AED)] flex items-center justify-center shadow-2xl shadow-purple-900/40">
...
function LeafNode({ data }: NodeProps) {
  ...
  return (
    <div style={{ borderColor: d.color + '60' }} className="w-[160px] rounded-lg border bg-[#0d0d0d] p-3">
      ...
      {d.note && <div className="text-[#475569] text-sm leading-relaxed">{d.note}</div>}
    </div>
  )
}
