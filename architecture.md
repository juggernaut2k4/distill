...
**Webhook URL:** `https://distill-peach.vercel.app/api/webhooks/twilio`

**Configure in Twilio Console:**
- For each phone number (shared or dedicated)
- Set "A MESSAGE COMES IN" webhook to: `https://distill-peach.vercel.app/api/webhooks/twilio`
- Method: POST
...
Configure Stripe webhook endpoint: `https://distill-peach.vercel.app/api/webhooks/stripe`
...
TWILIO_WEBHOOK_URL=https://distill-peach.vercel.app/api/webhooks/twilio
```
...
- Domain `distill-peach.vercel.app` must be verified in Resend dashboard
